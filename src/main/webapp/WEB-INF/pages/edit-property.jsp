                    ...
                    <div class="dashboard-container">
                       ...
                       <div class="dashboard-content">
                                ...
                                <c:if test="${not empty errormessage}">
						            ...
						            <form action="${pageContext.request.contextPath}/updateproperties" method="post" class="property-form">
						                ...
						                <div class="form-row">
						                    <div class="form-group">
						                        ...
						                        <select id="propertyType" name="propertyType" required>
						                            ...
						                            <option value="COMMERCIAL" ${property.propertyType == 'CommercialL' ? 'selected' : ''}>Commercial</option>
						                ...
						                <div class="form-group">
						                    ...
						                    <textarea id="description" name="description" rows="5" required>${property.description}</textarea>
						                </div>

						                <div class="form-row">
						                    <div class="form-group">
						                        <label for="price">Price (NPR)*</label>
						                        <input type="number" id="price" name="price" min="0" step="0.01" value="${property.price}" required>
						                    </div>

						                    <div class="form-group">
						                        <label for="size">Size</label>
						                        <input type="number" id="size" name="size" min="0" step="0.01" value="${property.size}">
						                    </div>

						                    <div class="form-group">
						                        <label for="sizeUnit">Unit</label>
						                        <select id="sizeUnit" name="sizeUnit">
						                            <option value="sq.ft" ${property.sizeUnit == 'sq.ft' ? 'selected' : ''}>sq.ft</option>
						                            <option value="sq.m" ${property.sizeUnit == 'sq.m' ? 'selected' : ''}>sq.m</option>
						                            <option value="acres" ${property.sizeUnit == 'acres' ? 'selected' : ''}>acres</option>
						                            <option value="hectares" ${property.sizeUnit == 'hectares' ? 'selected' : ''}>hectares</option>
						                        </select>
						                    </div>
						                </div>
						                ...
						                <div class="form-row">
						                    <div class="form-group">
						                        ...
						                        <input type="number" id="bedrooms" name="bedrooms" min="0" value="${property.bedrooms}">
						                    </div>

						                    <div class="form-group">
						                        <label for="bathrooms">Bathrooms</label>
						                        <input type="number" id="bathrooms" name="bathrooms" min="0" value="${property.bathrooms}">
						                    </div>
						                </div>
						            ...
						            <div class="property-images-section mt-4">
						                <h3>Property Images</h3>
						                <p>Manage images for this property:</p>
						                <a href="${pageContext.request.contextPath}/property-images?propertyId=${property.propertyId}" class="btn btn-primary">
						                    Manage Images
						                </a>
						            </div>
						        </div>
